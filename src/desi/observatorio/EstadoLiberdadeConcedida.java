...
public class EstadoLiberdadeConcedida extends Estado {
	public EstadoLiberdadeConcedida() {
	...
	public EstadoLiberdadeConcedida(Pergunta pergunta) {
		super(pergunta);
	}
	...
	public void executar(Long id) {
		if (id == 1) {
			...
			this.processo.setEstado(new EstadoLiberdadeConcedida());
		}
	}
}
